...
async function scrapeColleges() {
  ...
  let browser;
  let allColleges = [];
  const totalColleges = 2940; // Total colleges to scrape
  ...
  try {
    ...
    await page.goto('https://collegedunia.com/maharashtra-colleges', {
    ...
    while (scrapedCount < totalColleges && attempts < maxAttempts) {
      ...
      await page.goto(`https://collegedunia.com/maharashtra-colleges?page=${pageNum}`, {
        waitUntil: 'networkidle2',
      });
