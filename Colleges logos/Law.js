...
async function scrapeCollegeLogos() {
  ...
  let browser;
  let allLogos = [];
  const totalColleges = 1490; // Total colleges to scrape
  ...
  try {
    ...
    await page.goto('https://collegedunia.com/law-colleges', {
    ...
    while (scrapedCount < totalColleges && attempts < maxAttempts) {
      ...
      await page.goto(`https://collegedunia.com/law-colleges?page=${pageNum}`, {
        waitUntil: 'networkidle2',
      });
