...
async function scrapeCollegeLogos() {
  ...
  try {
    ...
    await page.goto('https://collegedunia.com/design-colleges', {
    ...
    const csvWriter = createObjectCsvWriter({
      path: 'Design_colleges_logos.csv',
      header: [
    ...
    while (scrapedCount < totalColleges && attempts < maxAttempts) {
      ...
      await page.goto(`https://collegedunia.com/design-colleges?page=${pageNum}`, {
        waitUntil: 'networkidle2',
      });
