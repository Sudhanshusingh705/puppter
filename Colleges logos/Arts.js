...
async function scrapeCollegeLogos() {
  ...
  let browser;
  let allLogos = [];
  const totalColleges = 5600; // Total colleges to scrape
  ...
  try {
    ...
    await page.goto('https://collegedunia.com/arts-colleges', {
    ...
    while (scrapedCount < totalColleges && attempts < maxAttempts) {
      ...
      await page.goto(`https://collegedunia.com/arts-colleges?page=${pageNum}`, {
        waitUntil: 'networkidle2',
      });
