 ...
 async function scrapeCollegeLogos() {
   ...
   let browser;
   let allLogos = [];
   const totalColleges = 450; // Total colleges to scrape
   ...
   try {
     ...
     await page.goto('https://collegedunia.com/aviation-colleges', {
     ...
     const csvWriter = createObjectCsvWriter({
       path: 'Aviation_colleges_logos.csv',
       header: [
     ...
     while (scrapedCount < totalColleges && attempts < maxAttempts) {
       ...
       await page.goto(`https://collegedunia.com/aviation-colleges?page=${pageNum}`, {
         waitUntil: 'networkidle2',
       });
