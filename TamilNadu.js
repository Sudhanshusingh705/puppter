...
async function scrapeColleges() {
  ...
  let browser;
  let allColleges = [];
  const totalColleges = 2440; // Total colleges to scrape
  ...
  try {
    ...
    await page.goto('https://collegedunia.com/tamil-nadu-colleges', {
    ...
    while (scrapedCount < totalColleges && attempts < maxAttempts) {
      ...
      await page.goto(`https://collegedunia.com/tamil-nadu-colleges?page=${pageNum}`, {
        waitUntil: 'networkidle2',
      });
