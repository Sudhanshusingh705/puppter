...
async function scrapeColleges() {
  ...
  let browser;
  let allColleges = [];
  const totalColleges = 1140; // Total colleges to scrape
  ...
  try {
    ...
    await page.goto('https://collegedunia.com/kerala-colleges', {
    ...
    while (scrapedCount < totalColleges && attempts < maxAttempts) {
      ...
      await page.goto(`https://collegedunia.com/kerala-colleges?page=${pageNum}`, {
        waitUntil: 'networkidle2',
      });
