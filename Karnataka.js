...
async function scrapeColleges() {
  ...
  let browser;
  let allColleges = [];
  const totalColleges = 1780; // Total colleges to scrape
  ...
  try {
    ...
    await page.goto('https://collegedunia.com/karnataka-colleges', {
    ...
    while (scrapedCount < totalColleges && attempts < maxAttempts) {
      ...
      await page.goto(`https://collegedunia.com/karnataka-colleges?page=${pageNum}`, {
        waitUntil: 'networkidle2',
      });
