...
async function scrapeColleges() {
  ...
  let browser;
  let allColleges = [];
  const totalColleges = 400; // Total colleges to scrape
  ...
  try {
    ...
    await page.goto('https://collegedunia.com/uttarakhand-colleges', {
    ...
    while (scrapedCount < totalColleges && attempts < maxAttempts) {
      ...
      await page.goto(`https://collegedunia.com/uttarakhand-colleges?page=${pageNum}`, {
        waitUntil: 'networkidle2',
      });
