...
async function scrapeColleges() {
  ...
  try {
    ...
    await page.goto('https://collegedunia.com/daman-and-diu-colleges', {
    ...
    while (scrapedCount < totalColleges && attempts < maxAttempts) {
      ...
      await page.goto(`https://collegedunia.com/daman-and-diu-colleges?page=${pageNum}`, {
        waitUntil: 'networkidle2',
      });
