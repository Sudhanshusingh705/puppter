...
async function scrapeColleges() {
  ...
  let browser;
  let allColleges = [];
  const totalColleges = 790; // Total colleges to scrape
  ...
  try {
    ...
    await page.goto('https://collegedunia.com/rajasthan-colleges', {
    ...
    while (scrapedCount < totalColleges && attempts < maxAttempts) {
      ...
      await page.goto(`https://collegedunia.com/rajasthan-colleges?page=${pageNum}`, {
        waitUntil: 'networkidle2',
      });
