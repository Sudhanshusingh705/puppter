...
async function scrapeColleges() {
  ...
  let browser;
  let allColleges = [];
  const totalColleges = 20; // Total colleges to scrape
  ...
  try {
    ...
    await page.goto('https://collegedunia.com/mizoram-colleges', {
    ...
    while (scrapedCount < totalColleges && attempts < maxAttempts) {
      ...
      await page.goto(`https://collegedunia.com/mizoram-colleges?page=${pageNum}`, {
        waitUntil: 'networkidle2',
      });
