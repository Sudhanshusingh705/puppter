...
async function scrapeColleges() {
  ...
  try {
    ...
    await page.goto('https://collegedunia.com/dadra-and-nagar-haveli-colleges', {
    ...
    const csvWriter = createObjectCsvWriter({
      path: 'DadraNagarHaveli_colleges.csv',
      header: [
    ...
    while (scrapedCount < totalColleges && attempts < maxAttempts) {
      ...
      await page.goto(`https://collegedunia.com/dadra-and-nagar-haveli-colleges?page=${pageNum}`, {
        waitUntil: 'networkidle2',
      });
