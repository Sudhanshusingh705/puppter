...
async function scrapeColleges() {
  ...
  let browser;
  let allColleges = [];
  const totalColleges = 1010; // Total colleges to scrape
  ...
  try {
    ...
    await page.goto('https://collegedunia.com/gujarat-colleges', {
    ...
    while (scrapedCount < totalColleges && attempts < maxAttempts) {
      ...
      await page.goto(`https://collegedunia.com/gujarat-colleges?page=${pageNum}`, {
        waitUntil: 'networkidle2',
      });
