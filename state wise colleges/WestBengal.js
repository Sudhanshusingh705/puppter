...
async function scrapeColleges() {
  ...
  let browser;
  let allColleges = [];
  const totalColleges = 980; // Total colleges to scrape
  ...
  try {
    ...
    await page.goto('https://collegedunia.com/west-bengal-colleges', {
    ...
    while (scrapedCount < totalColleges && attempts < maxAttempts) {
      ...
      await page.goto(`https://collegedunia.com/west-bengal-colleges?page=${pageNum}`, {
        waitUntil: 'networkidle2',
      });
