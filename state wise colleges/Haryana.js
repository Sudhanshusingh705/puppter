...
async function scrapeColleges() {
  ...
  let browser;
  let allColleges = [];
  const totalColleges = 900; // Total colleges to scrape
  ...
  try {
    ...
    await page.goto('https://collegedunia.com/haryana-colleges', {
    ...
    while (scrapedCount < totalColleges && attempts < maxAttempts) {
      ...
      await page.goto(`https://collegedunia.com/haryana-colleges?page=${pageNum}`, {
        waitUntil: 'networkidle2',
      });
