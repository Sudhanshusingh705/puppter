...
async function scrapeColleges() {
  ...
  let browser;
  let allColleges = [];
  const totalColleges = 500; // Total colleges to scrape
  ...
  try {
    ...
    await page.goto('https://collegedunia.com/odisha-colleges', {
    ...
    while (scrapedCount < totalColleges && attempts < maxAttempts) {
      ...
      await page.goto(`https://collegedunia.com/odisha-colleges?page=${pageNum}`, {
        waitUntil: 'networkidle2',
      });
