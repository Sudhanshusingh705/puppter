...
async function scrapeColleges() {
  ...
  let browser;
  let allColleges = [];
  const totalColleges = 70; // Total colleges to scrape
  ...
  try {
    ...
    await page.goto('https://collegedunia.com/meghalaya-colleges', {
    ...
    while (scrapedCount < totalColleges && attempts < maxAttempts) {
      ...
      await page.goto(`https://collegedunia.com/meghalaya-colleges?page=${pageNum}`, {
        waitUntil: 'networkidle2',
      });
