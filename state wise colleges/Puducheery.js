...
async function scrapeColleges() {
  ...
  try {
    ...
    await page.goto('https://collegedunia.com/puducherry-colleges', {
    ...
    while (scrapedCount < totalColleges && attempts < maxAttempts) {
      ...
      await page.goto(`https://collegedunia.com/puducherry-colleges?page=${pageNum}`, {
        waitUntil: 'networkidle2',
      });
