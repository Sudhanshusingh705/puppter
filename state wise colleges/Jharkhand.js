...
async function scrapeColleges() {
  ...
  let browser;
  let allColleges = [];
  const totalColleges = 250; // Total colleges to scrape
  ...
  try {
    ...
    await page.goto('https://collegedunia.com/jharkhand-colleges', {
    ...
    while (scrapedCount < totalColleges && attempts < maxAttempts) {
      ...
      await page.goto(`https://collegedunia.com/jharkhand-colleges?page=${pageNum}`, {
        waitUntil: 'networkidle2',
      });
