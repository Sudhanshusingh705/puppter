...
async function scrapeColleges() {
  ...
  let browser;
  let allColleges = [];
  const totalColleges = 60; // Total colleges to scrape
  ...
  try {
    ...
    await page.goto('https://collegedunia.com/nagaland-colleges', {
    ...
    while (scrapedCount < totalColleges && attempts < maxAttempts) {
      ...
      await page.goto(`https://collegedunia.com/nagaland-colleges?page=${pageNum}`, {
        waitUntil: 'networkidle2',
      });
